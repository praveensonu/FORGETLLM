...
# same as dpo collator
def npo_retain_collator(samples: List[Dict[str, Any]]) -> Dict[str, torch.Tensor]: # for batch dpo and npo which has factor like gradient difference
    """
